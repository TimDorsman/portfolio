export const Projects = [
    ...
    {
        id: 4,
        title: 'The Old Dance School CMS',
        description: `Na de website voor "The Old Dance School" werd er ook een custom admin portal ontwikkeld voor de klant. Binnen een Scrum team was ik medeverantwoordelijk voor het opzetten van de gehele Front-end en het koppelen van een aantal componenten aan een API d.m.v. React en Redux. Zo heb ik o.a. een "apartment status" component gemaakt waarbij ik een fetch resultaat binnen krijg en via een switch statement een class kan doorgeven. Ook heb ik er voor gezorgd dat de admin, "To do's" aan een appartement kan verbinden en de administrator de mogelijkheid heeft om nieuwe huurders te creëren. Ook is er test driven development toegepast in het project.`,
        image: 'odsa/home.png',
        skills: 'HTML(5) | SASS | JAVASCRIPT REACT.JS | REDUX | WEBPACK | TRAVIS | SCRUM | GIT | ENZYME | JEST | LARAVEL | MYSQL | API',
        client: 'Competa',
        startDate: '25-05-2017',
        endDate: '23-06-2018',
    ...
    {
        id: 5,
        title: 'GIZ: Deutsche Gesellschaft für Internationale Zusammenarbeit',
        description: `Een grootschalig project voor de Duitse overheid waarbij een applicatie ontwikkelt wordt om de samenwerking tussen bedrijven in Europa en Afrika te stimuleren. Binnen een multidisciplinair team ben ik medeverantwoordelijk voor het ontwikkelen van verschillende componenten binnen de applicatie. Dit wordt gedaan d.m.v. het schrijven van unit tests met Jest en Enzyme en vervolgens wordt er React.js, MobX en Sass (i.c.m. CSS modules) gebruikt om het component functioneel te maken en te stylen. Dit project is nog in ontwikkeling.`,
        image: 'giz/GIZ-home.png',
        skills: 'REACTJS | MOBX | SASS | JAVASCRIPT (ES6) | WEBPACK | MONGODB | NEXT.JS | JEST | ENZYME | CSS MODULES | TRAVIS',
        client: 'Competa',
        startDate: '25-05-2017',
        endDate: '23-06-2018',
        images: ['giz/GIZ-home.png', 'giz/GIZ-home-explain.png', 'giz/GIZ-goals.png', 'giz/GIZ-goals-single.png']
    },
    {
        id: 6,
        title: 'Advion',
